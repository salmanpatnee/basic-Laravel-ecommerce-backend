...
class CartController extends Controller
{
    ...
    public function store(CartStoreRequest $request)
    {
        ...
        if ($productInCart) {
            ...
            if (($attributes['quantity']) > $product->quantity) {
            ...
            $cartData['sub_total'] = $product->price * $attributes['quantity'];
